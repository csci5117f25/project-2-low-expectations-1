      ...
      <div class="slot-controls">
        ...
        <div class="bet-controls">
          ...
          <Button
            label="ALL IN"
            @click="allIn"
            :disabled="spinning || leverPulling"
            severity="danger"
          />
        </div>

        <div
          class="lever-instruction"
          v-if="!spinning && !leverPulling && !winMessage && !bankruptMessage"
        >
          <span class="instruction-text"
            ><i class="pi pi-hand-o-up"></i> Pull the lever to spin!</span
          >
        </div>
...
function loadLever() {
  ...
  loader.load(
    ...
    (gltf) => {
      ...
      leverModel.position.set(0.56, 0.8, 0)
...
function createOverlayReels() {
  ...
  const positions = [(0 - 1.41) * 0.145, (1 - 1.41) * 0.145, (2 - 1.41) * 0.145, (3 - 1.41) * 0.145]
  ...
  for (let i = 0; i < 4; i++) {
    slotLoader.load(
      ...
      (gltf) => {
        ...
        slotReel.position.set(positions[i], 0.85, 0.2)
